...
| # | Phase | Doc | Status |
|---|---|---|---|
| 1 | Retrieval infra: JDK, wiki-18 download, retrieval server | `docs/phase-1-retrieval-infra.md` | Ready for handoff — scripts pre-written (`scripts/{setup_retrieval.sh,retrieval_server.py,verify_retrieval.py}`), JDK version confirmed, just needs to be run |
